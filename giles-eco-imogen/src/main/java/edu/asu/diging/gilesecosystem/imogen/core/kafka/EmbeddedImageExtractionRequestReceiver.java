package edu.asu.diging.gilesecosystem.imogen.core.kafka;
...
public class EmbeddedImageExtractionRequestReceiver {
    ...
    @KafkaListener(id="imogen.extraction", topics = "${topic_storage_request_complete}")
